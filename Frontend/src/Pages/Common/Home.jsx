  ...
  return (
    <main className='overflow-hidden'>
        <section className='h-screen w-full  bg-cover bg-center flex items-center justify-center sm:justify-start px-2 sm:px-20' style={{backgroundImage:`url(${Home_img})`}}>
            ...
            viewport={{ once: true }}
            className='bg-black/60 py-10 px-5 sm:px-20 rounded-xl text-white w-fit'>
                <div>
                ...
                <div>
                    <button onClick={()=>navigate('/signup')} className='border-2 border-white p-2 rounded-md w-full font-bold hover:text-black hover:bg-white duration-500'>Get Started</button>
                </div>
            </motion.div>
        </section>
        ...
        <section className='p-3 sm:p-10'>
            ...
            <div className='lg:flex py-8'>
                ...
                className='w-full flex justify-center'>
                    <img className=' sm:h-[500px] rounded-lg' src={consult_img} alt="choose help" loading='lazy' />
                </motion.div>
                <div className=' mt-10 lg:mt-0 text-center lg:text-left'>
                    <div className='flex flex-col items-center md:px-8 space-y-5'>
                        ...
                        transition={{ duration: 0.8 }}
                        viewport={{ once: true }}
                        className='grid  sm:grid-cols-3 py-8 gap-10'>  
