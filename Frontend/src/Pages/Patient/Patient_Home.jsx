  ...
  return (
    ...
    <main>
        <section className='min-h-screen xl:flex justify-evenly items-center w-full pt-20 xl:pt-8 bg-[#E9E9E9]'>
            <div className='flex flex-col items-center space-y-8 justify-center p-5 h-full'>
            ...
            <div className='grid grid-cols-2 grid-rows-2 px-5 py-16 gap-3 min-h-[25rem] lg:h-screen w-full '>
                ...
                <div style={{backgroundImage:`url(/src/assets/Patient/pexels-fauxels-3228845.jpg)`}} className='min-w-[100px]  bg-cover rounded-xl bg-center'>               
                 </div>
            </div>
            </div>
    ...
    <section className='py-10 flex flex-col items-center'>
        <div className='text-center w-[80%] space-y-5'>
            ...
            Mental health care is unique to each person. Our network helps you find therapists specializing in various areas,
            including mood disorders, stress management, trauma recovery, and substance use. A specialized therapist 
            can provide targeted support and effective treatment approaches to best address your needs.
            </p>
        </div>
        <div className='grid sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-10 gap-x-40 py-20'>
       ...
       <div style={{backgroundImage:'url(/src/assets/Patient/pexels-liza-summer-6383267.jpg)'}} className=' bg-cover bg-center rounded-xl bg-red-300 row-span-2'>
           
        </div>
        <div style={{backgroundImage:'url(/src/assets/Patient/pexels-karolina-grabowska-5979728.jpg)'}} className=' bg-cover bg-center rounded-xl bg-black'>
            
        </div>
        <div style={{backgroundImage:'url(/src/assets/Patient/pexels-sofia-alejandra-946049-3007355.jpg)'}} className=' bg-cover bg-center rounded-xl bg-green-400 row-span-2'>
            
        </div>
        <div style={{backgroundImage:'url(/src/assets/Patient/pexels-olly-948875.jpg)'}} className=' bg-cover bg-center rounded-xl bg-slate-600'>
    ...
    <section className='flex items-center justify-center h-[50vh]'>
        ...
        <div className='flex justify-center lg:w-[50%] p-5'>
            <p className='font-thin text-center text-base md:text-lg'>
