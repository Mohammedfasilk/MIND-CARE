      ...
      <main className="overflow-hidden">
        ...
        <section className="py-10 flex flex-col items-center">
          <div className="text-center w-[80%] space-y-5">
            ...
            <p className="font-thin text-center text-base md:text-lg">
              ...
              disorders, stress management, trauma recovery, and substance use.
              A specialized therapist can provide targeted support and effective
        ...
        <section className="flex items-center justify-center h-[50vh]">
          <div className="flex flex-col items-center">
            ...
            >
              <p className="font-thin text-center text-base md:text-lg">
                Our approach centers on treating people with the same kindness
                and respect that we value for ourselves. We understand mental
                health challenges firsthand and support your pursuit of
                well-being with compassion. Whether it’s connecting you with the
                right therapist or supporting you through difficult times, we
                embrace you as part of our community.
              </p>
            </motion.div>
          </div>
        </section>
