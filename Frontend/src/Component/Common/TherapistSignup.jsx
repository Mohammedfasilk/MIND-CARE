...
function TherapistSignup({handleUser}) {
    useEffect(() => {
        window.scrollTo(0, 0);
      }, []); 
  ...
  return (
    <section className=' lg:flex justify-center w-full'>
            <div className='p-8'>
            <form onSubmit={handleSubmit(onSubmit)} className="bg-white w-full py-10 sm:p-5 lg:p-10 border-b-2 lg:border-b-0 lg:border-r-2 border-gray-300">
          ...
          <button  type="submit" className="bg-[#17A39C] text-white px-5 py-2 rounded-md hover:bg-[#17B89D]">
            ...
            <div className='flex items-center justify-center'>
                <h1 className=' text-base sm:text-xl lg:text-2xl pb-10'>
                   Are you a normal user? Signup <button onClick={()=>handleUser()} className='text-blue-600'>Here</button>
                </h1>
            </div>
        </section>
  )
